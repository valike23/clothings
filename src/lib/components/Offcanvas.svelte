<script lang="ts">
	...
	onMount(() => {
		...
		win.$('.canvas_open').on('click', function () {
			win.$('.offcanvas_menu_wrapper,.off_canvars_overlay').addClass('active');
		});

		win.$('.canvas_close,.off_canvars_overlay').on('click', function () {
			win.$('.offcanvas_menu_wrapper,.off_canvars_overlay').removeClass('active');
		});
	});
</script>
...
<div class="offcanvas_menu">
	<div class="canvas_open">
		<a href="javascript:void(0)"><i class="ion-navicon" /></a>
	</div>
	<div class="offcanvas_menu_wrapper">
		<div class="canvas_close">
			<a href="javascript:void(0)"><i class="ion-android-close" /></a>
		</div>
		...
		<div class="top_right">
			<ul>
				<li class="top_links">
					<a href="#">My Account <i class="ion-chevron-down" /></a>
				...
				<li class="currency">
					<a href="#">USD <i class="ion-chevron-down" /></a>
		...
		<div class="search_bar">
			<form action="#">
				...
				<button type="submit"><i class="ion-ios-search-strong" /></button>
			</form>
		</div>
		<div class="cart_area">
			...
			<div class="cart_link">
				<a href="#"><i class="fa fa-shopping-basket" />2 item(s)</a>
				<!--mini cart-->
				<div class="mini_cart">
					<div class="cart_item top">
						...
						<div class="cart_remove">
							<a href="#"><i class="ion-android-close" /></a>
						</div>
					</div>
		...
		<div class="offcanvas_footer">
			<span><a href="#"><i class="fa fa-envelope-o" /> info@yourdomain.com</a></span>
			<ul>
				<li class="facebook"><a href="#"><i class="fa fa-facebook" /></a></li>
				<li class="twitter"><a href="#"><i class="fa fa-twitter" /></a></li>
				<li class="pinterest"><a href="#"><i class="fa fa-pinterest-p" /></a></li>
				<li class="google-plus"><a href="#"><i class="fa fa-google-plus" /></a></li>
